...
class SettingIconGridBuy extends React.Component {
  ...
  render() {
      ...
      const quoteAssetRows = quoteAssets.map((quoteAsset, _j) => {
        return (
          <div
            ...
            className='col-xs-12 col-sm-6 coin-info-max-purchase-amount-wrapper grid-trade'>
            <Form.Group
              controlId={
    ...
    return (
      <div className='coin-info-grid-trade-wrapper coin-info-grid-trade-buy-wrapper grid-trade'>
        ...
        <div className='row'>
          <div className='col-12 text-right'>
            <button
              type='button'
              className='btn btn-sm btn-add-new-grid-trade-buy grid-trade-btn'
