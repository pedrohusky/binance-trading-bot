...
const { mongo, cache, PubSub, messenger } = require('../../helpers');
...
const getLastBuyPriceRemoveThreshold = async (
  ...
  _.set(
    symbolConfiguration,
    'buy.lastBuyPriceRemoveThreshold',
    newBuyLastBuyPriceRemoveThreshold
  );
...
const getMinPurchaseAmount = async (
  ...
  _.set(symbolConfiguration, 'buy.minPurchaseAmount', newMinimumPurchaseAmount);
