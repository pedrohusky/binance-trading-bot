...
class SettingIconGridSell extends React.Component {
  ...
  render() {
    ...
    const gridRows = gridTrade.map((grid, i) => {
      const quantityPercentageRows = quoteAssets.map((quoteAsset, _j) => {
        return (
          <div
            ...
            className='col-xs-12 col-sm-6 coin-info-sell-quantity-percentage-wrapper grid-trade'>
            <Form.Group
              controlId={
              ...
              <InputGroup size='sm'>
                ...
                <InputGroup.Append>
                  <InputGroup.Text>
                    {(
                      _.get(grid, `quantityPercentages.${quoteAsset}`, '') *
                        100 -
                      100
                    ).toFixed(2)}
                    %
      ...
      return (
        <React.Fragment key={'grid-row-sell-' + i}>
          <tr>
            <td
              className='align-middle font-weight-bold grid-trade'
              width='90%'>
              Grid Trade #{i + 1}
            </td>
            <td className='align-middle text-center grid-trade'>
              {i !== 0 ? (
                <button
                  type='button'
                  className='btn btn-sm btn-link p-0 grid-trade-btn'
          ...
          <tr>
            <td className='grid-trade' colSpan='2'>
              <div className='row'>
                  ...
                  <Form.Group
                    ...
                    <InputGroup size='sm'>
                      <Form.Control
                        ...
                        step='0.0001'
                        isInvalid={
                          _.get(validation, `${i}.stopPercentage`, true) ===
                          false
                        }
                      ...
                      <InputGroup.Append>
                        <InputGroup.Text>
                          {(grid.stopPercentage * 100 - 100).toFixed(2)}%
                        </InputGroup.Text>
                      </InputGroup.Append>
                    </InputGroup>
                  </Form.Group>
                ...
                <div className='col-xs-12 col-sm-6'>
                  <Form.Group
                    ...
                    <InputGroup size='sm'>
                      ...
                      <InputGroup.Append>
                        <InputGroup.Text>
                          {(grid.limitPercentage * 100 - 100).toFixed(2)}%
                        </InputGroup.Text>
                      </InputGroup.Append>
                    </InputGroup>
                  </Form.Group>
                ...
                <div className='col-12'>
                  <Form.Group
                    ...
                    <InputGroup size='sm'>
                      ...
                      <InputGroup.Append>
                        <InputGroup.Text>
                          {(grid.triggerPercentage * 100 - 100).toFixed(2)}%
                        </InputGroup.Text>
                      </InputGroup.Append>
                    </InputGroup>
                  </Form.Group>
    ...
    return (
      <div className='coin-info-grid-trade-wrapper coin-info-grid-trade-sell-wrapper grid-trade'>
        ...
        <div className='row'>
          <div className='col-12 text-right'>
            <button
              ...
              className='btn btn-sm btn-add-new-grid-trade-sell grid-trade-btn'
