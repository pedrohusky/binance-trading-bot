    ...
    const renderOpenOrders = sell.openOrders.map((openOrder, index) => {
      return (
        <div
          ...
          <div className='coin-info-column coin-info-column-order'>
            <span className='coin-info-label'>{jsonStrings[1]._type}:</span>
            <HightlightChange className='coin-info-value'>
              {openOrder.type}
            </HightlightChange>
          </div>
          <div className='coin-info-column coin-info-column-order'>
            <span className='coin-info-label'>{jsonStrings[1]._quantity}:</span>
            <HightlightChange className='coin-info-value'>
          ...
          {openOrder.price > 0 ? (
            <div className='coin-info-column coin-info-column-order'>
              <span className='coin-info-label'>{jsonStrings[1]._price}:</span>
              <HightlightChange className='coin-info-value'>
      ...
      <div className='coin-info-sub-wrapper'>
        <div className='coin-info-column coin-info-column-title'>
          <div className='coin-info-label'>
            {jsonStrings[0].sell_open_orders}{' '}
